...
public class AabMain {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 1) {
            ...
            System.err.println("Usage: <inAab> [convertRuleFile] [-j<n>]");
        ...
        final MappingReader mappingReader = new MappingReader(AabProtect.getAabProguardMapping(inputAab));
        ...
        final AabFolders aabFolders = new AabFolders(inputAab, aabOutDir);
